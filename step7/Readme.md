...
Replace content of **events.html** page with HTML snippet below. 
The page displays events generated by IoT nodes as a table on the Desktops and Tablets and as a list on Phones.
...
Replace content of **events.ts** file with the following code:
...
Add styles to **events.less** file in **/src/events** folder
```css
.app-events {
    table {
...
Resize browser window to the size of a phone:
